...
# app/routers/settings_domain.py
# app/routers/settings_domain.py
...
from ..schemas import DomainStatusResponse, DNSRecordDetail
from ..deps import verify_api_key

router = APIRouter(
    prefix="/settings",
    tags=["settings-domain"],
)
...
_cache_data: Optional[DomainStatusResponse] = None
...
def get_domain_status(api_key=Depends(verify_api_key)):
